...
namespace TurretSmart
{
    ...
    public static class HarmonyPatches
    {
        ...
        [HarmonyPrefix]
        public static void ShotReport_HitFactorFromShooter_Prefix(ShotReport __instance, Verb verb, ref float __result)
        {
        ...
        [HarmonyPatch(typeof(CompExplosive), "CheckState", new System.Type[] { typeof(float) })]
        [HarmonyPostfix]
        public static void CompExplosive_CheckState_Postfix(CompExplosive __instance, ref float __state)
        {
        ...
        private static BodyPartRecord FindTargetBodyPart(Pawn pawn, string targetPart)
        {
            ...
            switch (targetPart)
            {
                ...
                case "Arms":
                    return body.AllParts.FirstOrDefault(p => p.def == BodyPartDefOf.Shoulder);
